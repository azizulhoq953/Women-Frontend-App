...
const GetAllPosts = () => {
  ...
  useEffect(() => {
    const fetchAllPosts = async () => {
      ...
      try {
        const response = await fetch("https://women-backend-production.up.railway.app/api/admin/post/get", {
          method: "GET",
          headers: {
  ...
  const handleDeletePost = async (postId) => {
    ...
    try {
      const response = await fetch(`https://women-backend-production.up.railway.app/api/admin/post/${postId}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`,
